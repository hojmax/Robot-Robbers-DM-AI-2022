...
{
    int* scrooge_map = calloc(W * H * n_scrooges, sizeof(int));
...
int* get_entity_map(int* entities, int n_entities)
{
...
int* get_scrooge_map(int* scrooges, int n_scrooges) { return get_entity_map(scrooges, n_scrooges); }
int* get_cashbag_map(int* cashbags, int n_cashbags) { return get_entity_map(cashbags, n_cashbags); }